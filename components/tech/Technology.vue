<template>
  <section>
    <!-- <v-container class="technology-container">
      ...
      <v-image
        path="images/roadmap-desktop.png"
          ...
          >
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                Files uploaded to Skaina are erasure coded into shards.
              </v-text>
            </v-chip>
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                Each shard is stored on a unique Skaina storage node.
              </v-text>
            </v-chip>
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
    ...
    <v-stack justify="space-between" align="center">
        <v-stack direction="column" md-align="center" class="tech-stack">
          ...
          >
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                Every file uploaded to Skaina is assigned a DID, as per the W3C
                DID spec(link).
              </v-text>
            </v-chip>
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                DID points to document stored on the public Skaina blockchain
